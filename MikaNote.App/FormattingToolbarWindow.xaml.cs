...
public partial class FormattingToolbarWindow : Window
{
    ...
    public FormattingToolbarWindow()
    {
        InitializeComponent();
    ...
    {
        FormattingRootBorder.CornerRadius = new CornerRadius(Math.Max(0, cornerRadius));
    }

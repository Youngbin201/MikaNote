...
public partial class TodoOrganizerWindow : Window
{
    ...
    public ScrollViewer ItemsScrollViewer => OrganizerScrollViewer;

    public TodoOrganizerWindow()
    {
        InitializeComponent();
    ...
    public void ShowAt(double left, double top, double height)
    {
    ...
    {
        OrganizerRootBorder.CornerRadius = new CornerRadius(Math.Max(0, cornerRadius));
    }
